...
> models::PostTextMarkdownToHtml200Response post_text_markdown_to_html(post_text_markdown_to_html_request)
Markdown 转 HTML
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**post_text_markdown_to_html_request** | [**PostTextMarkdownToHtmlRequest**](PostTextMarkdownToHtmlRequest.md) | 请求体使用 `application/json`。`text` 必填；`format` 和 `sanitize` 可选。 | [required] |

### Return type

[**models::PostTextMarkdownToHtml200Response**](post_text_markdown_to_html_200_response.md)
...
> std::path::PathBuf post_text_markdown_to_pdf(post_text_markdown_to_pdf_request)
Markdown 转 PDF
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**post_text_markdown_to_pdf_request** | [**PostTextMarkdownToPdfRequest**](PostTextMarkdownToPdfRequest.md) | 请求体使用 `application/json`。`text` 必填，`theme` 和 `paper_size` 可选。 | [required] |
