...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**r#type** | **String** | 你想要查询的热榜平台。请从[支持的平台列表](#enum-list)中选择。 | [required] |
...
**forecast** | Option<**bool**> | 返回多天预报数据（最多7天），含每天的最高温度、最低温度、白天夜间天气、风向风力、日出日落等。 |  |
**hourly** | Option<**bool**> | 返回逐小时预报（24小时），含温度、天气、风向风速、湿度、降水概率等。 |  |
**minutely** | Option<**bool**> | 返回分钟级降水预报（仅国内城市），精确到2分钟。 |  |
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**post_misc_date_diff_request** | [**PostMiscDateDiffRequest**](PostMiscDateDiffRequest.md) |  | [required] |
