...
------------- | ------------- | ------------- | ------------- | -------------
**keyword** | **String** | 要分析的关键词，最长50字符。 | [required] |
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**post_search_aggregate_request** | [**PostSearchAggregateRequest**](PostSearchAggregateRequest.md) | 包含搜索参数的JSON对象 | [required] |
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**post_sensitive_word_analyze_request** | [**PostSensitiveWordAnalyzeRequest**](PostSensitiveWordAnalyzeRequest.md) | 包含待检测文本 'keywords' 的JSON对象 | [required] |
