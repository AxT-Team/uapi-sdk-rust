...
> models::GetSearchEngines200Response get_search_engines()
搜索引擎配置
...
[**models::GetSearchEngines200Response**](get_search_engines_200_response.md)
...
> models::PostSensitiveWordAnalyze200Response get_sensitive_word_analyze_query(keyword)
敏感词分析 (GET)
...
------------- | ------------- | ------------- | ------------- | -------------
**keyword** | **String** | 要分析的关键词，最长1,000字符。 | [required] |

### Return type

[**models::PostSensitiveWordAnalyze200Response**](post_sensitive_word_analyze_200_response.md)
...
> models::PostSearchAggregate200Response post_search_aggregate(post_search_aggregate_request)
智能搜索
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**post_search_aggregate_request** | [**PostSearchAggregateRequest**](PostSearchAggregateRequest.md) |  | [required] |

### Return type

[**models::PostSearchAggregate200Response**](post_search_aggregate_200_response.md)
...
> models::PostSensitiveWordAnalyze200Response post_sensitive_word_analyze(post_sensitive_word_analyze_request)
分析敏感词
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**post_sensitive_word_analyze_request** | [**PostSensitiveWordAnalyzeRequest**](PostSensitiveWordAnalyzeRequest.md) | 包含待检测关键词列表 `keywords` 的 JSON 对象。单条关键词最多 1,000 字符，总字符数最多 20,000。 | [required] |
...
> models::PostSensitiveWordQuickCheck200Response post_sensitive_word_quick_check(post_sensitive_word_quick_check_request)
敏感词检测（快速）
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**post_sensitive_word_quick_check_request** | [**PostSensitiveWordQuickCheckRequest**](PostSensitiveWordQuickCheckRequest.md) | 包含待检测文本 'text' 的JSON对象 | [required] |

### Return type

[**models::PostSensitiveWordQuickCheck200Response**](post_sensitive_word_quick_check_200_response.md)
