...
> models::GetWebTomarkdownAsyncStatus200Response get_web_tomarkdown_async_status(task_id)
查询网页转换任务状态和结果
...
------------- | ------------- | ------------- | ------------- | -------------
**task_id** | **String** | 任务ID（由提交接口返回） | [required] |

### Return type

[**models::GetWebTomarkdownAsyncStatus200Response**](get_web_tomarkdown_async_status_200_response.md)
...
> models::GetWebparseExtractimages200Response get_webparse_extractimages(url)
提取网页中的所有图片
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**url** | **String** | 需要提取图片的网页URL | [required] |

### Return type

[**models::GetWebparseExtractimages200Response**](get_webparse_extractimages_200_response.md)
...
> models::GetWebparseMetadata200Response get_webparse_metadata(url)
抓取并解析网页的元数据
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**url** | **String** | 需要提取元数据的网页URL | [required] |

### Return type

[**models::GetWebparseMetadata200Response**](get_webparse_metadata_200_response.md)
...
> models::PostWebTomarkdownAsync202Response post_web_tomarkdown_async(url)
深度抓取网页转Markdown
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**url** | **String** | 需要转换的网页URL。URL必须经过编码。 | [required] |

### Return type

[**models::PostWebTomarkdownAsync202Response**](post_web_tomarkdown_async_202_response.md)
