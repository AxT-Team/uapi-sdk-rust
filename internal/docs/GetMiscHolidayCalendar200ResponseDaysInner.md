...
**is_holiday** | Option<**bool**> | 当天是否存在节日、节气或法定事件。 | [optional]
**legal_holiday_name** | Option<**String**> | 法定节假日名称，无则为空或不返回。 | [optional]
**legal_holiday_type** | Option<**String**> | 法定假日类型：rest 或 workday_adjust。 | [optional]
**solar_festival** | Option<**String**> | 公历节日名称。有值时返回。 | [optional]
**lunar_festival** | Option<**String**> | 农历节日名称。有值时返回。 | [optional]
**solar_term** | Option<**String**> | 节气名称。有值时返回。 | [optional]
