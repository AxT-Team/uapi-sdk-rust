...
pub async fn get_misc_holiday_calendar(configuration: &configuration::Configuration, date: Option<&str>, month: Option<&str>, year: Option<&str>, timezone: Option<&str>, holiday_type: Option<&str>, include_nearby: Option<bool>, nearby_limit: Option<i32>, exclude_past: Option<bool>) -> Result<models::GetMiscHolidayCalendar200Response, Error<GetMiscHolidayCalendarError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let p_query_exclude_past = exclude_past;
    ...
    if let Some(ref param_value) = p_query_exclude_past {
        req_builder = req_builder.query(&[("exclude_past", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
...
pub async fn get_misc_hotboard(configuration: &configuration::Configuration, r#type: &str, time: Option<i64>, keyword: Option<&str>, time_start: Option<i64>, time_end: Option<i64>, limit: Option<i32>) -> Result<models::GetMiscHotboard200Response, Error<GetMiscHotboardError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_misc_tracking_query(configuration: &configuration::Configuration, tracking_number: &str, carrier_code: Option<&str>, phone: Option<&str>, full: Option<bool>) -> Result<models::GetMiscTrackingQuery200Response, Error<GetMiscTrackingQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_tracking_number = tracking_number;
