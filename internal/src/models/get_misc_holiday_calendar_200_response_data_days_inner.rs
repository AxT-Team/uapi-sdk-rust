...
pub struct GetMiscHolidayCalendar200ResponseDataDaysInner {
    /// 公历日期（YYYY-MM-DD）。
...
impl GetMiscHolidayCalendar200ResponseDataDaysInner {
    pub fn new() -> GetMiscHolidayCalendar200ResponseDataDaysInner {
