...
pub struct GetMiscHolidayCalendar200ResponseDataSummary {
    /// 查询范围内总天数。
...
impl GetMiscHolidayCalendar200ResponseDataSummary {
    /// 统计摘要。
    pub fn new() -> GetMiscHolidayCalendar200ResponseDataSummary {
